...
<header class="site-header" data-site-header-inner>
  <div class="wrap nav-row">
    ...
    <button class="menu-btn" type="button" data-menu aria-expanded="false" aria-controls="mobileMenu" aria-label="Open menu">
      <svg class="menu-icon" viewBox="0 0 28 20" aria-hidden="true" focusable="false">
        <path d="M1 2.5H27"></path>
        <path d="M1 10H27"></path>
        <path d="M1 17.5H27"></path>
      </svg>
    </button>
    ...
    <nav class="nav-right" aria-label="Quick actions">
      ...
      <button class="nav-action bag-button" type="button" data-bag-open aria-label="Open bag">
        <svg class="bag-icon" viewBox="0 0 24 26" aria-hidden="true" focusable="false">
          <path d="M5 8.5h14l1 15H4l1-15Z"></path>
          <path d="M8 9V7a4 4 0 0 1 8 0v2"></path>
        </svg>
        <span class="bag-label">Bag</span>
        <sup class="cart-count" data-cart-count aria-label="Items in bag">0</sup>
      </button>
    </nav>
  </div>
</header>
